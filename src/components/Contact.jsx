...
const Contact = () => {
  return (
    ...
    >
      ...
      <div className="bg-black pb-10 w-full flex justify-center ">
        <a target={"_blank"} href="https://www.linkedin.com/in/yogesh-kumar-0ba549231" className="m-2">
          <svg
        ...
        <a href="https://github.com/Yogeshkumar-24" target={"_blank"} className="m-2">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            className="h-5 w-5 text-white mx-auto hover:scale-110 duration-200"
            fill="currentColor"
