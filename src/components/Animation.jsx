...
export default function TypeWriter({ appendClass, prefix }) {
    ...
    let className = "flex flex-col gap-4 bg-gradient-to-b from-black to-black pt-40";
    if (appendClass) className += " " + appendClass;

    // Typewriter effect base class
    const typeWriterClass = "font-bold border-r-2 pr-1"
    ...
    return (
        <div className={className}>
            <div className="text-5xl md:text-6xl text-center mx-auto ">
                <span className='text-white font-bold'>Yogesh </span><span className="text-blue-400 font-bold">Kumar</span>
            </div>
